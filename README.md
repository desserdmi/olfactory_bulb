...
Due to multi-modal features (n of features < n of samples) we are going to have (e.g. label volumes derived from MRI data, clinical functional measurements, psychological test results) we are going use a similar approach.   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwMDA2MTk2NiwyOTUyODcwODgsOTA4MD
